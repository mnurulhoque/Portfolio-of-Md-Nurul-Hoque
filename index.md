...
![Missing values before cleaning](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Missing.values.before.cleaning.png)
...
![Missing values after cleaning](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Missing.values.after.cleaning.png)
...
![Distribution of target variable in training data](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Distribution.of.target.variable.in.training.data.png)
...
![Distribution of target variable after balancing](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Distribution.of.target.variable.after.balancing.png)
...
![Optimized hyperparameters](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Optimized.hyperparameters.png)
...
![Baseline model performance](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Baseline.model.performance.png)

### Model Performance After Optimization:
After hyperparameter tuning, the optimized performance results are as follows:

![Model performance after optimization](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Model.performance.after.optimization.png)
...
![Feature Importance](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/Feature.Importance.png)
...
![LIME explanation-1](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/LIME.explanation-1.png)
...
![LIME explanation-2](https://github.com/mnurulhoque/Prediction-of-Used-Car-Prices-Leveraging-Data-and-Machine-Learning/releases/download/v1.0/LIME.explanation-2.png)
